...
# #3} The number of trips that started in Brooklyn (Pickup_Borough field) and ended in Staten Island (Dropoff_Borough field)
    ...
    selected_df =nyc_df1.filter((col("Pickup_Borough")=="Brooklyn") & (col("Dropoff_Borough") == "Staten Island"))
    selected_df_final = selected_df.select("Pickup_Borough","Dropoff_Borough","Pickup_Zone")

    selected_df_final.show(10)
    print("Count of trips from Brooklyn to Staten Island: ", selected_df_final.count())
